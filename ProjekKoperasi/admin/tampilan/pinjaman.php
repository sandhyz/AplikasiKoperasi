              ...
              <div class="modal-dialog ">
                <div class="modal-content ">
                  ...
                  <div class="modal-body">
                    ...
                    <!-- content goes here -->
                    <form id="formpinjam" action="../config-pinjaman/tambah.php" method="post">
                      <div class="form-group">
                        <label for="nama">Nama Lengkap</label>
                        <select class="form-control" id="nama" name="id_user" placeholder="NAMA">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="jumlah_pinjaman" id="jumlah_pinjaman" class="form-control" placeholder="Jumlah Pinjaman">
                      </div>

                      <div class="form-group">
                        <label for="nama">Lama Cicilan</label>
                        <select class="form-control" id="cicilan" name="cicilan">
                          <option value="-" selected disabled>-- Pilih Lama Cicilan</option>
                      ...
                      <div class="form-group">
                        ...
                        <input id="bungaan" name="bunga" class="form-control" placeholder="1% Perbulan" >
                      </div>

                      <div class="form-group">
                        <label for="nama">Angsuran</label>
                        <input type="text" name="angsuran" id="angsuran" class="form-control" placeholder="Angsuran" >
                      </div>

                      <div class="form-group">
                        <label for="nama">Tanggal Jatuh Tempo</label>
                        <input type="date" class="form-control" id="start" name="tanggal" value="2023-01-01" min="2023-01-01">
                      </div>
